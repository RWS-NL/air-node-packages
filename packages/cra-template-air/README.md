<div align="center">
  ...
  <p>
<h1> Rijkswaterstaat cra-template-air </h1>
<h3> Create-React-App template for AIR projects </h3>
  </p>
...
[![npm bundle size](https://img.shields.io/bundlephobia/min/cra-template-air?label=utils%20-%20minified&logo=webpack&style=flat-square)](https://bundlephobia.com/result?p=cra-template-air)
[![npm bundle size](https://img.shields.io/bundlephobia/minzip/cra-template-air?label=utils%20-%20minzipped&logo=webpack&style=flat-square)](https://bundlephobia.com/result?p=cra-template-air)

**Versions**

[![npm](https://img.shields.io/npm/v/cra-template-air?color=crimson&label=utils%20version&logo=npm&style=flat-square)](https://www.npmjs.com/package/cra-template-air)
...
```sh
yarn create react-app --template air
```
