...
In various files we have put `{{variables}}`. These `{{variables}}` should be replaced before starting development. You can find them by searching for `{{`.
...
```sh
yarn stub:start # If you didn't start the stubrunner yet
yarn test
```

### End to end testing

For the end to end testing of this project please see the [air-end-to-end-testing] repository
...
[air-end-to-end-testing]: https://github.com/RWS-NL/air-end-to-end-testing
