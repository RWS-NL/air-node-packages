<div align="center">
  ...
  <p>
<h1> Rijkswaterstaat stylelint-config </h1>
<h3> A <a href="https://stylelint.io/">stylelint config</a> for all AIR frontend applications</h3>
  </p>
...
```sh
yarn add @rws-air/stylelint-config
```
...
Check out [the docs on github pages](https://rws-nl.github.io/air-node-packages/modules/_rws_air_stylelint-config.html)